[
  ...
  {
    question:
      "Câu 12. Trường hợp nào sau đây cơ quan, tổ chức, doanh nghiệp được tự quyết định việc lựa chọn nhà thầu trên cơ sở bảo đảm công khai, minh bạch, hiệu quả và trách nhiệm giải trình?",
    options: [
  ...
  {
    question:
      "Câu 13. Điều kiện để tổ chức đấu thầu quốc tế lựa chọn nhà thầu thực hiện gói thầu mua sắm hàng hóa là gì?",
    options: [
  ...
  {
    question: "Câu 14. Ngôn ngữ sử dụng đối với đấu thầu quốc tế là gì?",
    options: [
      "A. Tiếng Việt",
      "B. Tiếng Đức",
  ...
  {
    question:
      "Câu 19. Đối với gói thầu xây lắp đấu thầu không qua mạng, hồ sơ đề xuất tài chính của nhà thầu không được lựa chọn sẽ được trả lại khi nào?",
    options: [
  ...
  {
    question:
      "Câu 42. Khi đánh giá về năng lực kinh nghiệm đối với gói thầu mua sắm hàng hóa, nhà thầu được đánh giá là đạt khi?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "B. Không được tính là sai lệch",
      "C. Được tính là sai lệch thiếu",
      "D. Phải lập báo cáo thẩm định",
    ],
    answer: "",
  },
  {
    question: "Câu 107. Khi nào chủ đầu tư được phép ký hợp đồng với nhà thầu?",
    options: [
      "A. Sau khi nhận được văn bản chấp thuận kết quả lựa chọn nhà thầu từ người có thẩm quyền",
      "B. Ngay khi chủ đầu tư quyết định trúng thầu",
      "C. Sau khi hết thời hạn giải quyết kiến nghị",
      "D. Phương án A và C đều đúng",
    ],
    answer: "",
  },
  {
    question:
      "Câu 108. Chủ đầu tư có trách nhiệm đăng tải thông tin chủ yếu của hợp đồng trên Hệ thống đấu thầu qua mạng quốc gia chậm nhất là bao nhiêu ngày làm việc kể từ ngày ký kết hợp đồng?",
    options: [
      "A. 05 ngày làm việc kể từ ngày ký kết hợp đồng",
      "B. 05 ngày làm việc kể từ ngày hợp đồng có hiệu lực",
      "C. 05 ngày kể từ ngày hợp đồng có hiệu lực",
      "D. 05 ngày làm việc kể từ ngày nhà thầu nộp",
    ],
    answer: "",
  },
  {
    question:
      "Câu 109. Nhà thầu được phép rút E-HSDT đã nộp trên Hệ thống mạng đấu thầu quốc gia khi nào?",
    options: [
      "A. Trước thời điểm đóng thầu",
      "B. Sau thời điểm đóng thầu nhưng trước khi mở thầu",
      "C. Trước khi nhà thầu được trao hợp đồng",
  ...
  {
    question:
      "Câu 110. Trong đấu thầu qua mạng, khi E-HSDT của một nhà thầu không thể mở được do lỗi kỹ thuật, chủ đầu tư xử lý thế nào?",
    options: [
      "A. Loại nhà thầu này ra khỏi quá trình đấu thầu",
      "B. Yêu cầu nhà thầu nộp lại E-HSDT trên Hệ thống để đánh giá",
      "C. Tổ chuyên gia đánh giá dựa trên E-HSDT hiện có",
      "D. Chủ đầu tư quyết định theo hình thức bỏ thầu",
    ],
    answer: "",
  },
  {
    question:
      "Câu 111. Đối với kiến nghị về kết quả lựa chọn nhà thầu, trường hợp nhà thầu gửi đơn kiến nghị đồng thời đến bộ phận thường trực và chủ đầu tư thì chủ thể nào có trách nhiệm giải quyết kiến nghị?",
    options: [
      "A. Người có thẩm quyền",
      "B. Chủ đầu tư",
  ...
  },
  {
    ...
    options: [
      "A. Đơn vị mua sắm tập trung thực hiện trách nhiệm của chủ đầu tư quy định của Luật Đấu thầu",
      "B. Đơn vị mua sắm tập trung thực hiện trách nhiệm của bên mời thầu quy định của Luật Đấu thầu",
      "C. Đơn vị mua sắm tập trung thực hiện trách nhiệm của tổ chuyên gia theo quy định của Luật Đấu thầu",
    ],
    answer: "",
  },
  {
